...
const HERO_SLIDES = [
    {
        ...
        subtitle: "Wujudkan kemandirian ekonomi umat dengan prinsip syariah yang transparan, modern, dan penuh berkah bersama BMT NU Lumajang.",
    ...
    {
        id: 2,
        title: "Simpanan Haji & Umroh",
        subtitle: "Rencanakan ibadah suci Anda dengan tenang. Tabungan aman, terencana, dan terhubung langsung dengan sistem keberangkatan.",
        cta: "Buka Tabungan",
    ...
    },
    {
        ...
        subtitle: "Transparansi adalah kunci. Simak laporan pertanggungjawaban pengurus dan pembagian SHU tahunan kami.",
        cta: "Baca Laporan",
        bgClass: "bg-slate-900",
        image: "https://scontent.fmlg8-1.fna.fbcdn.net/v/t39.30808-6/494181098_1487429089366592_2968411195852970881_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeHftFJyrsUlnb0n3v5Xvr6MB7fKtj-cSx8Ht8q2P5xLH8gvbTXE9fRnaEDBhd3zrCk3ZjhAo3XFoWQcvOksL6yj&_nc_ohc=itubHf6G9mwQ7kNvwHSrgyZ&_nc_oc=AdmzJsNXco64_KizMlY9XNaRtiR0HrBqmqu2xR7LWzswgZiO2NtbO65Ik3ocaSMsW04&_nc_zt=23&_nc_ht=scontent.fmlg8-1.fna&_nc_gid=dhgkFcBWHI3KSf_1yPZusg&oh=00_AfuCxr4U6vCDLsaNC0Nc32QNeBsj8yEv5Fmtom3DwDdmjA&oe=6985DEDF"
    }
];
        ...
        <div className="min-h-screen bg-slate-50 font-display text-slate-800 antialiased overflow-x-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                            <div className="flex items-center gap-4 px-4">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-gray-900">Rp 500 M+</h3>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 px-4 pt-4 md:pt-0">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-gray-900">25.000+</h3>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 px-4 pt-4 md:pt-0">
                                <div className="p-3 rounded-full bg-emerald-50 text-emerald-700">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500 font-bold uppercase tracking-wider">Berdiri Sejak</p>
                                    <h3 className="text-3xl font-black text-gray-900">1998</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 text-center max-w-3xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-sm text-slate-500">Pengelolaan dana yang transparan dan dapat dipertanggungjawabkan.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <div className="mx-auto w-16 h-16 bg-gold-100 rounded-full flex items-center justify-center mb-4 text-amber-600">
                                <Banknote className="w-8 h-8" />
                            </div>
                            <h3 className="font-bold text-lg mb-2">Syariah</h3>
                            <p className="text-sm text-slate-500">Bebas riba, gharar, dan maysir. Murni sesuai prinsip Islam.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <div className="mx-auto w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4 text-blue-600">
                                <Users className="w-8 h-8" />
                            </div>
                            <h3 className="font-bold text-lg mb-2">Maslahah</h3>
                            <p className="text-sm text-slate-500">Keuntungan dinikmati bersama untuk kesejahteraan umat.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <ArabesqueCard variant="interactive" title="Simpanan Haji" icon={<span className="text-2xl">🕋</span>}>
                            <p className="text-slate-600 mb-6 text-sm">Persiapkan perjalanan ibadah Anda dengan aman dan terencana sejak dini dengan bagi hasil yang kompetitif.</p>
                            <TactileButton fullWidth>Pelajari Selengkapnya</TactileButton>
                        </ArabesqueCard>
                        <ArabesqueCard variant="interactive" title="Modal Usaha" icon={<span className="text-2xl">🏪</span>}>
                            <p className="text-slate-600 mb-6 text-sm">Bantuan permodalan untuk UMKM dengan skema syariah yang adil dan memajukan ekonomi lokal.</p>
                            <TactileButton fullWidth>Ajukan Sekarang</TactileButton>
                        </ArabesqueCard>
                        <ArabesqueCard variant="interactive" title="Pembiayaan Emas" icon={<span className="text-2xl">⚜️</span>}>
                            <p className="text-slate-600 mb-6 text-sm">Investasi masa depan yang aman dengan kepemilikan emas batangan secara angsuran syariah.</p>
                            <TactileButton fullWidth>Simulasi Emas</TactileButton>
                        </ArabesqueCard>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center mb-10">
                        ...
                        <TactileButton variant="ghost">Lihat Berita Lainnya</TactileButton>
                    </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="group cursor-pointer">
                                ...
                                <h3 className="font-bold text-lg text-slate-900 group-hover:text-emerald-700 transition-colors line-clamp-2 mb-2">
                                    BMT NU Lumajang Raih Penghargaan Koperasi Syariah Terbaik Tingkat Provinsi
                                </h3>
                                <p className="text-sm text-slate-500 line-clamp-2">
                                    Prestasi membanggakan kembali diraih oleh BMT NU Lumajang dalam ajang Koperasi Award 2025 yang diselenggarakan di Surabaya...
                                </p>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-24 bg-gradient-to-br from-gold to-yellow-500 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center text-emerald-950">
                    ...
                    <p className="text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10">
                        Proses pendaftaran mudah, cepat, dan bisa dilakukan secara online. Customer service kami siap membantu Anda 24/7.
                    </p>
                    <TactileButton className="bg-emerald-900 text-white border-emerald-950 hover:bg-emerald-800 px-10 h-16 text-lg shadow-2xl">
                        Buka Rekening via WhatsApp <ExternalLink className="ml-2 w-5 h-5" />
                    </TactileButton>
                </div>
            </section>
