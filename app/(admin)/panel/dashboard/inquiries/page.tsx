    ...
    return (
        <main className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-black text-slate-800 tracking-tight uppercase">Pengaduan Warga</h1>
                    <p className="text-sm text-slate-500 mt-1">Daftar pengaduan, laporan, dan pesan dari warga.</p>
                </div>
            </div>
